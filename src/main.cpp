...
//fix out-of-first-blackbook temple frea scene (redirect marker close enough triggers before bridge, too fast)
...
void send_speech_context(RE::TESObjectREFR* speaker, std::string speech_text, bool force_display)
{
    ...
    std::string speaker_name = MiscThings::insert_object_into_list_and_get_info(speaker, false, false, true);//speaker->GetName();
