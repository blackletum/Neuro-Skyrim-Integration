...
namespace my_scene {
    ...
    public:
        ...
        virtual ~myBGSSceneAction();  // 00

        // add
        virtual bool                        LoadSceneAction(RE::TESFile* a_mod);                     // 01
        virtual bool                        Unk_02(int id);                                        // 02
        ...
        virtual void                        LoadBuffer(void* a_arg1, RE::BGSLoadGameBuffer* a_buf);  // 09
        virtual void                        Unk_0A(void);                                        // 0A
        virtual void                        Unk_0B(void);                                        // 0B - { unk14 &= 0xFC; }
        virtual void                        Unk_0C(void);                                        // 0C - { return; }
        virtual void                        Unk_0D(void);                                        // 0D
        [[nodiscard]] virtual RE::EmotionType   GetEmotionType() const;                              // 0E - { return kNeutral; }
    ...
    //static_assert(sizeof(myBGSSceneAction) == 0x20);
